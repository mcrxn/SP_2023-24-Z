 ...
 * Ако студентот има 0-50 поени не го положил предметот, ако има 51-60 го положил со 6, 61-70 го положил со 7, 71-80 го положил со 8,
 * 81-90 го положил со 9 и над 90 го положил со 10.
 * Да се испечати оценката која ја имал студентот,неговите поени и да се испечати Ima uslov za povisoka ocenka доколку има услов да добие повисока оценка,
...
int main(){
    ...
    if(totalPoints > 0 && totalPoints <=50 ){
        ...
        totalPoints % 10 == 0 ? cout << "Ima uslov za povisoka ocenka" : cout << "Nema uslov za povisoka ocenka" << endl;
